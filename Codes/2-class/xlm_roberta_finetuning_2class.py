# -*- coding: utf-8 -*-
"""XLM-RoBERTa-FineTuning_2class.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1anD4q_Hc-qUQwLvlCCtR7-moKJJcpG8X
"""
...
"""### Tokenization for XLM-RoBERTa and Formatting
To feed our text to XLM-RoBERTa, it must be split into tokens, and then these tokens must be mapped to their index from the tokenizer vocabulary.
...
max_input_length = 200 ##round the max length to 400
