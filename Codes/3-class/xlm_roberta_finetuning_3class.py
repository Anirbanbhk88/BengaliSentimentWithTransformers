# -*- coding: utf-8 -*-
"""XLM-RoBERTa-FineTuning_3class.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Mo6tKie9IlVmVFhvRJQUlEVdd2yH3mb1
"""
...
if torch.cuda.is_available():    
    ...
    print('We will use the GPU:', torch.cuda.get_device_name(5))
else:
...
df_train = pd.read_csv(base_path +'Dataset/'+Dataset + '/train.csv')
df_test = pd.read_csv(base_path +'Dataset/'+Dataset + '/test.csv')

df_train

"""### Replacing the labels such that 0-> Negative, 1->Positive, 2-> Neutral"""

df_train = df_train.replace({0:2, 1:1, 2:0})
df_test = df_train.replace({0:2, 1:1, 2:0})
